...
export default function DeleteReportDialog({open, isLoading, onClose, onDelete}) {
        ...
        <Dialog open={open} onOpenChange={onClose}>
            <DialogContent className="lg:max-w-md [&>button]:cursor-pointer [&>button]:opacity-100 [&>button]:focus:ring-0 [&>button]:focus:ring-transparent [&>button]:focus:ring-offset-0 p-0 px-6 pt-3 pb-6">
                <DialogHeader className="gap-1">
                    <DialogTitle className="text-xl font-semibold text-black text-center">Delete Report</DialogTitle>
                    <DialogDescription className="text-center text-brand-gray text-base font-medium">
                        Are you sure you want to delete report?<br />This action is irreversible.
                    </DialogDescription>
                </DialogHeader>
